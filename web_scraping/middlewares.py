...
class ImmoscoutSpiderMiddleware:
...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def __init__(self, settings):
        self.scrapeops_api_key = settings.get('164cda43-b50a-408a-bcdd-e91c8e046804')
        self.scrapeops_endpoint = settings.get('https://headers.scrapeops.io/v1/user-agents',
